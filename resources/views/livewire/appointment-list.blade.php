        ...
        <tr>
          <th class="px-4 py-3">
            <button type="button"
                    ...
                    wire:click="sortByColumn('cliente')" title="Ordenar por cliente" aria-label="Ordenar por cliente">
              Cliente
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 px-4 py-6">
      <div class="w-full max-w-md rounded-3xl border border-white/10 bg-slate-900 p-6 shadow-2xl">
        ...
        <div class="mt-6 flex flex-wrap justify-end gap-2">
          ...
          <x-botones.accion variant="delete" icono="delete" type="button" wire:click="deleteConfirmed">Eliminar
          </x-botones.accion>
        </div>
      </div>
    </div>
