  ...
  <div class="rounded-2xl border border-white/10 bg-slate-900/50 p-5">
    <div class="flex items-center gap-3">
      ...
      <div>
        ...
        <p class="mt-0.5 text-xs text-slate-400">Descarga un backup JSON con todos los ajustes del sistema.</p>
      </div>
    </div>
  ...
  <div class="rounded-2xl border border-white/10 bg-slate-900/50 p-5">
    <div class="flex items-center gap-3">
      ...
      <div>
        ...
        <p class="mt-0.5 text-xs text-slate-400">Restaura ajustes desde un archivo JSON exportado previamente.</p>
      </div>
    </div>
    ...
    <div class="mt-4 grid gap-2">
      @foreach ($sections as $key => $label)
        <label class="flex items-center gap-2.5 cursor-pointer group">
          <input type="checkbox"
                 wire:model.live="selectedImport.{{ $key }}"
                 class="size-4 rounded border-white/20 bg-white/5 text-yellow-400 focus:ring-yellow-400/50">
