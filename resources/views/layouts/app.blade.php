                ...
                @if (auth()->check() && (int) auth()->id() === 1)
                    <div class="mt-12">
                        ...
                        <div class="mt-2 grid gap-2">
                            <x-navegacion.aside-link route="admin.users.create" route-is="admin.users.*" color="orange" text="Usuarios" icono="usuarios">
                            </x-navegacion.aside-link>
                            <x-navegacion.aside-link route="admin.security.edit" route-is="admin.security.*" color="rose" text="Seguridad" icono="seguridad"/>
                            <x-navegacion.aside-link route="imports.index" route-is="imports.*" color="violet" icono="excel" text="Importar Excel"/>
                            <x-navegacion.aside-link route="settings.index" route-is="settings.*" color="cyan"  text="Ajustes" icono="ajustes"/>
                        </div>
                    </div>
                @endif
            </div>
